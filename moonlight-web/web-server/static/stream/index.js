...
export class Stream {
    ...
    createPipelines() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (_a = this.logger) === null || _a === void 0 ? void 0 : _a.debug(`Supported Pipes: {`);
            let isFirst = true;
            for (const [key, value] of pipesInfo.entries()) {
                (_b = this.logger) === null || _b === void 0 ? void 0 : _b.debug(`${isFirst ? "" : ","}"${(_c = getPipe(key)) === null || _c === void 0 ? void 0 : _c.name}": ${JSON.stringify(value)}`);
                isFirst = false;
            }
            ...
            const videoPipeline = `${(_e = this.transport) === null || _e === void 0 ? void 0 : _e.getChannel(TransportChannelId.HOST_VIDEO).type} (transport) -> ${(_f = this.videoRenderer) === null || _f === void 0 ? void 0 : _f.implementationName} (renderer)`;
            this.debugLog(`Using video pipeline: ${videoPipeline}`);
            const audioPipeline = `${(_g = this.transport) === null || _g === void 0 ? void 0 : _g.getChannel(TransportChannelId.HOST_AUDIO).type} (transport) -> ${(_h = this.audioPlayer) === null || _h === void 0 ? void 0 : _h.implementationName} (player)`;
    ...
    createAudioPlayer() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (audio.type == "audiotrack") {
                const { audioPlayer, error } = yield buildAudioPipeline("audiotrack", this.settings);
                if (error) {
                    return false;
                }
                ...
                const { audioPlayer, error } = yield buildAudioPipeline("data", this.settings);
                if (error) {
                    return false;
                }
                audioPlayer.mount(this.divElement);
